...
#define PROGRAM_NAME	"circuclust"
...
UNS_OPT(maxoverhangs,		10,			0,			UINT_MAX)	// -
...
UNS_OPT(minlen,				32,			1,			UINT_MAX)	// 
UNS_OPT(maxlen,				50000,		1,			UINT_MAX)	// 
UNS_OPT(code,				1,			UINT_MAX,	UINT_MAX)	// 
